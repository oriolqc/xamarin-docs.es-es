...
description: Este documento describen estrategias para escenarios como bases de datos, acceso a archivos, operaciones de red y código asincrónico de uso compartido de código resulta muy práctico.
ms.prod: xamarin
