...
description: Este documento incluye vínculos a diversas guías que describen cómo usar la herramienta Sharpie objetivo, que se usa para automatizar el proceso de creación de enlaces de C# para código de Objective-C.
ms.prod: xamarin
