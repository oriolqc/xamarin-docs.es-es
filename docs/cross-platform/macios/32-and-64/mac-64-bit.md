...
description: Esta guía describe cómo actualizar sus aplicaciones Xamarin.Mac para 64 bits de destino. También proporciona ejemplos de los tipos de errores que pueden producirse al realizar este cambio.
ms.prod: xamarin
