...
description: Este tutorial muestra cómo compilar aplicaciones nativas de Xamarin.iOS y Xamarin.Android que usan la lógica de negocios escrita en Visual Basic.NET.
ms.prod: xamarin
