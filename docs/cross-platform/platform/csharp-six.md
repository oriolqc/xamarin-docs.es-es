...
El Mono C# compilador 6 se incluye en Mono 4.0 y versiones posterior, que es [descargar gratuitamente](http://www.mono-project.com/download/).
...
^ o *[Microsoft Build Tools 2015](http://www.microsoft.com/download/details.aspx?id=48159)* para comando de línea compilación o los servidores de compilación, por ejemplo.
