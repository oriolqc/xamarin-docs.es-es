...
description: Este documento proporciona una comparación de los controles de interfaz de usuario de Xamarin.Forms, Windows Forms y WPF. También incluye vínculos a otra documentación que compara WPF a Xamarin.Forms.
author: asb3993
ms.author: amburns
ms.date: 04/26/2017
...
ms.locfileid: "34782351"
---
# <a name="ui-controls-comparison"></a>Comparación de los controles de interfaz de usuario

A continuación se muestra una comparación de los controles de Xamarin.Forms con formularios Windows Forms y WPF, tomando como base [esta tabla](/dotnet/framework/wpf/advanced/windows-forms-controls-and-equivalent-wpf-controls).

Obtenga más información sobre la [similitudes y diferencias entre WPF y Xamarin.Forms](wpf.md) que ayudará a actualizar sus conocimientos del escritorio para el desarrollo de aplicaciones móviles.
...
|[BindingSource](https://msdn.microsoft.com/library/system.windows.forms.bindingsource(v=vs.110).aspx)|[CollectionViewSource](https://msdn.microsoft.com/library/system.windows.data.collectionviewsource(v=vs.110).aspx)|Enlazar la propiedad, p. ej. BindingContext|
...
|[ComboBox](https://msdn.microsoft.com/library/system.windows.forms.combobox(v=vs.110).aspx)|[ComboBox](https://msdn.microsoft.com/library/system.windows.controls.combobox(v=vs.110).aspx) (no admite Autocompletar)|Selector de|
...
|[DomainUpDown](https://msdn.microsoft.com/library/system.windows.forms.domainupdown(v=vs.110).aspx)|[Cuadro de texto](https://msdn.microsoft.com/library/system.windows.controls.textbox(v=vs.110).aspx) y dos [RepeatButton](https://msdn.microsoft.com/library/system.windows.controls.primitives.repeatbutton(v=vs.110).aspx) controles.|Paso a paso desencadene|
...
|[LinkLabel](https://msdn.microsoft.com/library/system.windows.forms.linklabel(v=vs.110).aspx)|No hay control equivalente (puede usar el [hipervínculo](https://msdn.microsoft.com/library/system.windows.documents.hyperlink(v=vs.110).aspx) clase para hospedar hipervínculos dentro del contenido dinámico).|-|
...
|[NumericUpDown](https://msdn.microsoft.com/library/system.windows.forms.numericupdown(v=vs.110).aspx)|[Cuadro de texto](https://msdn.microsoft.com/library/system.windows.controls.textbox(v=vs.110).aspx) y dos [RepeatButton](https://msdn.microsoft.com/library/system.windows.controls.primitives.repeatbutton(v=vs.110).aspx) controles.|Paso a paso desencadene|
...
|[Panel](https://msdn.microsoft.com/library/system.windows.forms.panel(v=vs.110).aspx)|[Canvas](https://msdn.microsoft.com/library/system.windows.controls.canvas(v=vs.110).aspx)|Vista o AbsoluteLayout|
...
|[RichTextBox](https://msdn.microsoft.com/library/system.windows.forms.richtextbox(v=vs.110).aspx)|[RichTextBox](https://msdn.microsoft.com/library/system.windows.controls.richtextbox(v=vs.110).aspx)|Editor no admite texto enriquecido de (con formato), la entrada de texto de una sola línea|
...
|[SoundPlayer](https://msdn.microsoft.com/library/system.media.soundplayer(v=vs.110).aspx)|[El Reproductor de Media](https://msdn.microsoft.com/library/system.windows.media.mediaplayer(v=vs.110).aspx)|-|
...
|[Control TableLayoutPanel](https://msdn.microsoft.com/library/system.windows.forms.tablelayoutpanel(v=vs.110).aspx)|[Grid](https://msdn.microsoft.com/library/system.windows.controls.grid(v=vs.110).aspx)|Cuadrícula|
|[TextBox](https://msdn.microsoft.com/library/system.windows.forms.textbox(v=vs.110).aspx)|[TextBox](https://msdn.microsoft.com/library/system.windows.controls.textbox(v=vs.110).aspx)|Editor no admite texto enriquecido de (con formato)|
...
|[TreeView](https://msdn.microsoft.com/library/system.windows.forms.treeview(v=vs.110).aspx)|[TreeView](https://msdn.microsoft.com/library/system.windows.controls.treeview(v=vs.110).aspx)|Considere la posibilidad de ListView jerárquica en un NavigationPage|
|[Control de usuario](https://msdn.microsoft.com/library/system.windows.forms.usercontrol(v=vs.110).aspx)|[Control de usuario](https://msdn.microsoft.com/library/system.windows.controls.usercontrol(v=vs.110).aspx)|Ver y también representadores personalizados|
