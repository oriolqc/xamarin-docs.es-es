---
title: Implementar SiriKit en Xamarin.iOS
description: Este documento describe los pasos necesarios para implementar la compatibilidad de SiriKit en las aplicaciones de Xamarin.iOS. Describe las extensiones de intentos y de interfaz de usuario de intentos.
ms.prod: xamarin
...
ms.locfileid: "34788854"
---
# <a name="implementing-sirikit-in-xamarinios"></a>Implementar SiriKit en Xamarin.iOS
...
> [!IMPORTANT]
> Siri trata vocabulario personalizado como sugerencias y se incorporará como gran parte de la terminología como sea posible. Sin embargo, espacio vocabulario personalizado se limita lo que es preciso registrar _sólo_ la terminología que puede resultar confusa, por lo tanto, manteniendo el número total de términos registrados al mínimo.
...
2. En el cuadro de diálogo seleccione **Visual C# > iOS extensiones > extensión intención** y haga clic en el **siguiente** botón:

    [![](implementing-sirikit-images/intents05.w157-sml.png "Seleccionar extensión intención")](implementing-sirikit-images/intents05.w157.png#lightbox)
3. A continuación, escriba un **nombre** para el intento de extensión y haga clic en el **Aceptar** botón.
1. En el **el Explorador de soluciones**, haga doble clic en el **referencias** carpeta de la extensión de calidades recién creado y elija **Agregar > referencia**. Compruebe el nombre del proyecto de biblioteca de código compartido común (que la aplicación creada anteriormente) y haga clic en el **Aceptar** botón:
