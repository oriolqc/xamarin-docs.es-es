...
2. Expanda el `NSExtension` clave.
3. Agregar el `UNNotificationExtensionCategory` clave como tipo **cadena** con el valor de la categoría a la que pertenece la extensión (en este ejemplo ' invitación a un evento): 
