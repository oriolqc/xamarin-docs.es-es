...
description: Este documento describe cómo configurar una aplicación de ARKit en Xamarin.iOS, a continuación, examina cómo se procesan marcos, cómo ajustar la cámara, cómo detectar planos, cómo trabajar con iluminación y mucho más. También se tratan UrhoSharp y escribir código para HoloLens.
ms.prod: xamarin
