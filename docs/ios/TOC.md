...
##### [Emparejamiento con Mac](get-started/installation/windows/connecting-to-mac/index.md)
...
### [Selector de pila HttpClient e implementación de SSL/TLS](~/cross-platform/macios/http-stack.md?context=xamarin/ios)
