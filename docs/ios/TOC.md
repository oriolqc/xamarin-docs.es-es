...
##### [Aprovisionamiento gratuito](get-started/installation/device-provisioning/free-provisioning.md)
...
#### [Manual de C# para desarrolladores de Objective-C](get-started/objective-c-developers/primer.md)
...
### [Subprocesos](app-fundamentals/threading.md)
...
### [Diseñador de iOS](user-interface/designer/index.md)
...
##### [Editar](user-interface/controls/tables/editing.md)
...
#### [Visión](platform/introduction-to-ios11/vision.md)
...
### [Compra desde la aplicación](platform/in-app-purchasing/index.md)
...
### [Asignaciones](~/essentials/maps.md?context=xamarin/ios)
...
##### [Paso 2. Configurar](~/cross-platform/data-cloud/active-directory/get-started/configure.md?context=xamarin/ios)
#### [Acceso a Graph API](~/cross-platform/data-cloud/active-directory/graph.md?context=xamarin/ios)
### [Azure Mobile Apps](~/cross-platform/data-cloud/mobile-apps.md)
### [Acceso a datos en ASP.NET (Visual Studio)](data-cloud/data/index.md)
...
### [App Distribution (Distribución de aplicaciones)](deploy-test/app-distribution/index.md)
#### [Distribución a través del App Store](deploy-test/app-distribution/app-store-distribution/index.md)
##### [Configurar la aplicación en iTunes Connect](deploy-test/app-distribution/app-store-distribution/itunesconnect.md)
##### [Publicación en el App Store](deploy-test/app-distribution/app-store-distribution/publishing-to-the-app-store.md)
...
### [Aprovisionamiento y firma de código](deploy-test/provisioning/index.md)
#### [Trabajar con capacidades](deploy-test/provisioning/capabilities/index.md)
##### [Capacidades de Wallet](deploy-test/provisioning/capabilities/wallet-capabilities.md)
##### [Capacidades de iCloud](deploy-test/provisioning/capabilities/icloud-capabilities.md)
##### [Capacidades de Apple Pay](deploy-test/provisioning/capabilities/apple-pay-capabilities.md)
##### [Capacidades de los grupos de aplicaciones](deploy-test/provisioning/capabilities/app-groups-capabilities.md)
...
### [Generar perfiles de aplicaciones de Xamarin.iOS con Instruments](deploy-test/using-instruments-to-detect-native-leaks-using-markheap.md)
...
### [Punto flotante](internals/floating-point.md)
...
#### [Referencias del proyecto](watchos/get-started/project-references.md)
...
#### [Imagen](watchos/user-interface/image.md)
#### [Tabla](watchos/user-interface/table.md)
...
### [Implementación y prueba](tvos/deploy-test/index.md)
#### [App Distribution (Distribución de aplicaciones)](tvos/deploy-test/app-distribution/index.md)
...
#### [Marcos de trabajo](tvos/internals/frameworks.md)
