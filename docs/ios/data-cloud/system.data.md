...
> [!IMPORTANT]
> **Advertencia:** tal y como se ha mencionado en el ejemplo de código anterior, es aconsejable para incrustar las cadenas de comandos SQL ya que hace que el código sea vulnerable a [inyección de código SQL](http://en.wikipedia.org/wiki/SQL_injection).
