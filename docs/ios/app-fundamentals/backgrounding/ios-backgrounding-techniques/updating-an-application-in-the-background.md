...
description: Este documento describe varias maneras de actualizar una aplicación de Xamarin.iOS que está en segundo plano, como supervisión de la región, captura de fondo y notificaciones remotas.
ms.prod: xamarin
