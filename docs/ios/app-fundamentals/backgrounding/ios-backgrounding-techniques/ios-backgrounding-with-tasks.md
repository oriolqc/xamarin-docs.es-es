...
description: Este documento describe cómo usar tareas en segundo plano para realizar tareas de larga duración después de que una aplicación se coloca en segundo plano.
ms.prod: xamarin
