...
Cuando se trabaja con C# y .NET en una aplicación de Xamarin.Mac, tendrá acceso a la misma alerta que un desarrollador que trabaje en *Objective-C* y *Xcode* does. 
