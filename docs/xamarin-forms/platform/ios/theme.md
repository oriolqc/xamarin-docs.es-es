...
description: En este artículo se explica cómo establecer el aspecto de iOS específica sin usar a un representador personalizado de Xamarin.Forms.
ms.prod: xamarin
