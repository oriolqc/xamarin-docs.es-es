...
description: En este artículo se explica cómo agregar la funcionalidad de sincronización sin conexión a una aplicación de Xamarin.Forms que consume un back-end de aplicaciones móviles de Azure.
ms.prod: xamarin
