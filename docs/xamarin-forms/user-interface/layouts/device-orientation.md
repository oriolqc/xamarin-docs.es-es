...
Para especificar opciones de orientación en Windows Phone, sustituirlo por el código para habilitar las orientaciones que desee:
...
- [Mostrar una imagen basada en la orientación de pantalla](https://developer.xamarin.comhttps://developer.xamarin.com/recipes/cross-platform/xamarin-forms/controls/screen-orientation/)
