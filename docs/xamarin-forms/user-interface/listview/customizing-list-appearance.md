...
description: En este artículo se explica cómo personalizar ListView en aplicaciones de Xamarin.Forms mediante el uso de encabezados, pies de página, grupos y las celdas de alto variable.
ms.prod: xamarin
