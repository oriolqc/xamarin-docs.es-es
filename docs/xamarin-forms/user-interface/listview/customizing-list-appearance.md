...
**Tenga en cuenta**: establecer cualquiera de estas propiedades en Android después de cargar la `ListView` implica una reducción del rendimiento de gran tamaño.
