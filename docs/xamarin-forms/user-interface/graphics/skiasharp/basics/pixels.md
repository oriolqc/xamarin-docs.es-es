...
description: En este artículo se explora las diferencias entre las coordenadas SkiaSharp e Xamarin.Forms y se muestra cómo hacerlo con código de ejemplo.
ms.prod: xamarin
