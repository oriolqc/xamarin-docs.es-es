...
- [`ThumbImage`](xref:Xamarin.Forms.Slider.ThumbImageProperty) es la imagen que se utilizará para el control de posición de tipo [ `FileImageSource` ](xref:Xamarin.Forms.FileImageSource).
