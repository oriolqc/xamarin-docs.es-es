...
El [controlador de vista previa de XAML](~/xamarin-forms/xaml/xaml-previewer.md) anunció en Xamarin Evolve 2016 está disponible para las pruebas en el canal alfa.
