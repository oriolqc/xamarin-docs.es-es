...
Ahora, agregue `On` elementos. Para cada uno de ellos establezca la `Platform` propiedad y el `Value` propiedad en el marcado para la `Thickness` propiedad:
