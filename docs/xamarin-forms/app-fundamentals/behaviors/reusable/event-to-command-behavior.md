...
[ ![](event-to-command-behavior-images/screenshots-sml.png "Ejemplo de aplicación con EventToCommandBehavior")](event-to-command-behavior-images/screenshots.png "aplicación con EventToCommandBehavior de ejemplo")
