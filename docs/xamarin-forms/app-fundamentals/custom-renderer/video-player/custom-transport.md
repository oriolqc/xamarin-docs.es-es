...
description: En este artículo se explica cómo implementar controles de transporte personalizado en una aplicación de Reproductor de vídeo, uso de Xamarin.Forms.
ms.prod: xamarin
