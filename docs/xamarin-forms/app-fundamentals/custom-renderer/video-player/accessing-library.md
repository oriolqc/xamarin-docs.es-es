...
description: Este artículo explica cómo obtener acceso a la biblioteca de vídeos del dispositivo en una aplicación de Reproductor de vídeo, uso de Xamarin.Forms.
ms.prod: xamarin
