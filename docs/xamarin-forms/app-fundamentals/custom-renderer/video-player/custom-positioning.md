...
description: En este artículo se explica cómo implementar una barra de posición personalizada en una aplicación de Reproductor de vídeo, uso de Xamarin.Forms.
ms.prod: xamarin
