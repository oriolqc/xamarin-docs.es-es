...
A menudo es necesario compartir datos entre páginas & #x 2014; para transferir datos a una página navegar y de una página devolver los datos a la página que lo invocó. Hay varias técnicas para hacerlo.
