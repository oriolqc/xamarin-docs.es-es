...
### [XAML Basics (Conceptos básicos de XAML)](xaml/xaml-basics/index.md)
...
#### [Parte 5. Enlaces de datos a MVVM](xaml/xaml-basics/data-bindings-to-mvvm.md)
...
### [Pasar argumentos](xaml/passing-arguments.md)
...
##### [Resaltar una ruta en un mapa](app-fundamentals/custom-renderer/map/polyline-map-overlay.md)
#### [Personalización de una ListView](app-fundamentals/custom-renderer/listview.md)
#### [Personalización de ViewCell](app-fundamentals/custom-renderer/viewcell.md)
#### [Implementación de una vista](app-fundamentals/custom-renderer/view.md)
#### [Implementación de HybridWebView](app-fundamentals/custom-renderer/hybridwebview.md)
#### [Implementación de un reproductor de vídeo](app-fundamentals/custom-renderer/video-player/index.md)
##### [Creación de reproductores de vídeo de plataforma](app-fundamentals/custom-renderer/video-player/player-creation.md)
##### [Reproducción de un vídeo web](app-fundamentals/custom-renderer/video-player/web-videos.md)
##### [Enlazar orígenes de vídeo con el reproductor](app-fundamentals/custom-renderer/video-player/source-bindings.md)
##### [Carga de vídeos de recursos de aplicación](app-fundamentals/custom-renderer/video-player/loading-resources.md)
##### [Acceder a la biblioteca de vídeos del dispositivo](app-fundamentals/custom-renderer/video-player/accessing-library.md)
##### [Controles de transporte de vídeo personalizados](app-fundamentals/custom-renderer/video-player/custom-transport.md)
##### [Barra de posición de vídeo personalizada](app-fundamentals/custom-renderer/video-player/custom-positioning.md)
...
#### [Comprobar el estado de la batería](app-fundamentals/dependency-service/battery-info.md)
...
#### [Mostrar elementos emergentes](app-fundamentals/navigation/pop-ups.md)
### [Shell](app-fundamentals/shell.md)
### [Plantillas](app-fundamentals/templates/index.md)
...
### [Botón](user-interface/button.md)
### [CollectionView](user-interface/collectionview/index.md)
#### [Datos](user-interface/collectionview/populate-data.md)
...
### [Controls Reference (Referencia de controles)](user-interface/controls/index.md)
...
#### [Controls Reference (Referencia de controles)](user-interface/datapages/controls.md)
...
#### [Cuadrícula](user-interface/layouts/grid.md)
...
### [Asignaciones](user-interface/map.md)
...
#### [Etiqueta](user-interface/text/label.md)
...
### [Elemento visual](user-interface/visual/index.md)
...
### [Asignaciones](~/essentials/maps.md?context=xamarin/xamarin-forms)
...
#### [Comprobación de](data-cloud/serverless/azure-functions.md)
### [Almacenamiento de datos en una base de datos de documentos](data-cloud/cosmosdb/index.md)
#### [Consumo de una base de datos de documentos de Azure Cosmos DB](data-cloud/cosmosdb/consuming.md)
#### [Autenticación a los usuarios con una base de datos de documentos de Azure Cosmos DB](data-cloud/cosmosdb/authentication.md)
...
### [Publicación de aplicaciones de UWP](/windows/uwp/packaging/)
...
#### [¿Por qué mi proyecto de Xamarin.Forms.Maps para Android produce el siguiente error: COMPILETODALVIK : UNEXPECTED TOP-LEVEL ERROR?](troubleshooting/questions/maps-compiletodalvik-error.md)
