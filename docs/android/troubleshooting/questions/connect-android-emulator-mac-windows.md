---
title: ¿Es posible conectarse a emuladores de Android ejecutando en un equipo Mac desde una máquina virtual de Windows?
...
ms.locfileid: "50115645"
---
# <a name="is-it-possible-to-connect-to-android-emulators-running-on-a-mac-from-a-windows-vm"></a>¿Es posible conectarse a emuladores de Android ejecutando en un equipo Mac desde una máquina virtual de Windows?
...
4.  _Opción 1_: uso [`nc`](https://developer.apple.com/library/mac/documentation/Darwin/Reference/ManPages/man1/nc.1.html)
    ...
    _Opción 2_: uso [`pfctl`](https://developer.apple.com/library/mac/documentation/Darwin/Reference/ManPages/man8/pfctl.8.html)
...
En teoría, otro enfoque sería usar `adb`de capacidad integrada para conectarse a un `adb` server que se ejecutan en un equipo remoto (ver por ejemplo [ http://stackoverflow.com/a/18551325 ](http://stackoverflow.com/a/18551325)).
