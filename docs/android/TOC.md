...
#### [Vista previa de OpenJDK Mobile de Microsoft](get-started/installation/openjdk.md)
...
### [Acceso a archivos con Xamarin.Android](platform/files/index.md)
#### [Almacenamiento externo](platform/files/external-storage.md)
...
### [Vista previa de Android P](platform/android-p.md)
...
### [Selector](~/essentials/launcher.md?context=xamarin/android)
### [Magnetómetro](~/essentials/magnetometer.md?context=xamarin/android)
### [Subproceso principal](~/essentials/main-thread.md?context=xamarin/android)
...
### [Sensor de orientación](~/essentials/orientation-sensor.md?context=xamarin/android)
...
### [Seguimiento de versiones](~/essentials/version-tracking.md?context=xamarin/android)
...
#### [Depurador en el emulador](deploy-test/debugging/debug-on-emulator.md)
