...
[![Captura de pantalla de un diseño relativo con un control TextView, EditText y dos botones](relative-layout-images/helloviews2.png)](relative-layout-images/helloviews2.png)
