...
description: Este documento describe los errores generados mediante la inserción. NET. Los errores se enumeran por código y proporcionado una descripción para ayudar a solucionar el problema.
ms.prod: xamarin
...
ms.locfileid: "34793724"
---
# <a name="net-embedding-errors"></a>Errores de incrustación de .NET
