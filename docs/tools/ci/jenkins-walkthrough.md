...
Si está utilizando TFS para el control de código fuente [omitir](#Using_TFS_for_Source_Code_Management) esta sección y vaya a la sección siguiente con TFS.
